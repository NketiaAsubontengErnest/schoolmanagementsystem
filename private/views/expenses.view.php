                ...
                <form action="" method="post">
                    ...
                    <div class="flex gap-4">
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="date" type="date" value="<?= esc(get_var('date')) ?>"
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <select name="typeid" id="" class="block w-full mt-1 text-sm <?= isset($errors['typeid']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input">
                                ...
                                <?php foreach ($rowstype as $type): ?>
                                    <option value="<?= esc($type->id) ?>"><?= esc($type->expntype) ?></option>
                                <?php endforeach ?>
                            </select>
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="amount" value="<?= esc(get_var('amount')) ?>"
                    ...
                    <label class="block flex-1 text-sm">
                        ...
                        <textarea name="discription" id="" class="block w-full mt-1 text-sm <?= isset($errors['discription']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-red form-input"><?= esc(get_var('discription')) ?></textarea>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Expends Date</th>
                            <th class="px-4 py-3">Expends Type</th>
                                    ...
                                    <?php if (Auth::access('administrator')): ?>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="<?= HOME ?>/expenses/edit/<?= esc($row->id) ?>"
