        ...
        <div
            ...
            <form action="" method="post">
                ...
                <label class="block py-4 text-sm">
                    ...
                    <input name="title"
                        class="block w-full mt-1 text-sm <?= isset($errors['title']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                        value="<?= esc(get_var('title')) ?>" />
                        ...
                        <?php if ($rows) : ?>
                            <?php foreach ($rows as $row) : ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <p class="font-semibold"><?= esc($row->title) ?></p>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <!-- Edit Link -->
                                            <a href="<?= HOME ?>/subjects/edit/<?= esc($row->id) ?>"
