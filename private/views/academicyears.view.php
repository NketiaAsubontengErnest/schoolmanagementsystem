            ...
            <form action="" method="post">
                ...
                <label class="block py-4 text-sm">
                    ...
                    <input name="academicyear"
                        ...
                        value="<?= esc(get_var('academicyear')) ?>" />
                        ...
                        <?php if ($rows) : ?>
                            <?php foreach ($rows as $row) : ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <p class="font-semibold"><?= esc($row->academicyear) ?></p>
                                    </td>
                                    <td class="px-4 py-3">
                                        <p class="font-semibold"><?= esc($row->year) ?></p>
                                    </td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="<?= HOME ?>/academicyears/edit/<?= esc($row->id) ?>"
