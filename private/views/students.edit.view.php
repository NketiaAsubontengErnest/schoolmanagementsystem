            ...
            <div
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-6">
                        ...
                        <!-- School Fee -->
                        <label class="block flex-1 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">NHIS ID Number <code class="text-red-700">*</code></span>
                            <input name="health_insurance"
                                ...
                                value="<?= get_var('health_insurance', $row->health_insurance) ?>"" />
                    ...
                    <div class="flex gap-6">
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="mother_name"
                                ...
                                value="<?= get_var('mother_name', $row->mother_name) ?>" />
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="mother_phone"
                                ...
                                value="<?= get_var('mother_phone', $row->mother_phone) ?>" />
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="father_name"
                                ...
                                value="<?= get_var('father_name', $row->father_name) ?>" />
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="father_phone"
                                ...
                                value="<?= get_var('father_phone', $row->father_phone) ?>" />
                    ...
                    <div class="flex gap-6">
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="emegency_name"
                                ...
                                value="<?= get_var('emegency_name', $row->emegency_name) ?>" />
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="emegency_phone"
                                ...
                                value="<?= get_var('emegency_phone', $row->emegency_phone) ?>" />
                        ...
                        <label class="block flex-1 text-sm">
                            ...
                            <input name="emegency_location"
                                ...
                                value="<?= get_var('emegency_location', $row->emegency_location) ?>" />
                    ...
                    <div class="flex gap-6">
                        <label class="block flex-1 text-sm">
                            ...
                            <select name="classid" id="" class="block w-full mt-1 text-sm <?= isset($errors['classid']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input">
                                <option <?= get_select('classid', '', $row->classid) ?> value="">-- Select Class --</option>
                                <?php foreach ($rowclass as $class): ?>
                                    <option <?= get_select('classid', esc($class->id, $row->classid)) ?> value="<?= esc($class->id) ?>"><?= esc($class->classname) ?></option>
                                <?php endforeach; ?>
                            </select>
