        ...
        <div
            ...
            <form action="" method="post">
                ...
                <label class="block py-4 text-sm">
                    ...
                    <input name="expntype"
                        class="block w-full mt-1 text-sm <?= isset($errors['expntype']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                        value="<?= esc(get_var('expntype')) ?>" />
                    <?php if (isset($errors['expntype'])) : ?>
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="<?= HOME ?>/expentypes/edit/<?= esc($row->id) ?>"
