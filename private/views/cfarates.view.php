            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form action="" method="post">
                    ...
                    <label class="block py-4 text-sm">
                        ...
                        <input name="rateamount"
                            class="block w-full mt-1 text-sm <?= isset($errors['rateamount']) ? 'border-red-600' : '' ?> dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                            value="<?= esc(get_var('rateamount')) ?>" />
                        <?php if (isset($errors['rateamount'])) : ?>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">CFA Rate Amount</th>
                        ...
                        <?php if ($rows) : ?>
                            <?php foreach ($rows as $row) : ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <p class="font-semibold"><?= esc($row->rateamount) ?></p>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="<?= HOME ?>/cfarates/edit/<?= esc($row->id) ?>"
