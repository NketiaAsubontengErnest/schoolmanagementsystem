...
<aside
  ...
  <?php $this->view('includes/menucontrol', ['crumbs' => $crumbs, 'actives' => $actives, 'hiddenSearch' => $hiddenSearch,]) ?>
      ...
      <div class="flex justify-center flex-1 lg:mr-32">
          ...
          <div
            ...
            <form action="" method="get">
              <input
                ...
                aria-label="Search"
                value="<?= isset($_GET['search_list']) ? htmlspecialchars($_GET['search_list']) : '' ?>"
                id="searchInput"
                autofocus />
            </form>
            ...
            <script>
              ...
              input.addEventListener('input', () => {
                ...
                typingTimer = setTimeout(() => {
                  input.form.submit(); // Submit form after delay
                }, typingDelay);
              });
        ...
        <?php if ($hiddenSearch == 'date'): ?>
          <div
            ...
            <form action="" method="get">
              <input name="search_list" type="date"
                class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                type="text"
                placeholder="Search from list"
          ...
          <button
            ...
            <div class="flex items-center space-x-4">
              ...
              <img
                ...
                alt=""
                aria-hidden="true" />
              <span class="text-gray-800 dark:text-gray-200"><?= esc(Auth::getStaff()->first_name) ?></span>
            </div>
          </button>
