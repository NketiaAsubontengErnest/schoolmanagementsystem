                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">PTA Income</th>
                            <th class="px-4 py-3">School Fees</th>
                            <th class="px-4 py-3">Other Income</th>
                            <th class="px-4 py-3">Expenditure</th>
                            <th class="px-4 py-3">Daily Balance</th>
                            ...
                            <?php foreach ($rows as $row) : ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= esc($row->pta_income) ?>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= '-'?>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= esc($row->total_income) ?>
                                    </td>

                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= esc($row->total_expense) ?>
                                    </td>
                                    
                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= esc($row->daily_balance) ?>
                                    </td>
                                    
                                    <td class="px-4 py-3 text-sm">
                                        GHC <?= esc($row->cumulative_balance) ?>
                                    </td>                                    
                                </tr>
                            <?php endforeach ?>
                        <?php else: ?>
